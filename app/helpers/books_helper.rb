...
def book_fix_provider(book)
  if book.provider == 999 && book.remark5.present?
    book.remark5
  else
    t('book.provider.elem' + book.provider.to_s)
  end
end
